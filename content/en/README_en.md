...
|---------------|-----------|
| Just installed Claude Code | Chapter 1 → Chapter 2 → Chapter 3 |
| Using it but not feeling the power | Chapter 4 → Chapter 7 → Chapter 10 |
| Want to use it in iOS/Swift projects | Chapter 9 (standalone read) |
...
*Written from hands-on experience with Claude Code (claude-sonnet-4-6)*
