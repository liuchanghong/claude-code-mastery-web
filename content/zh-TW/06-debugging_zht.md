...
1. **完整 > 簡潔**：除錯時，給多而不要讓 Claude 猜
2. **先分析後修改**：讓 Claude 說出判斷，你確認後再改
3. **假設驅動**：給 Claude 你自己的假設，讓它幫你驗證
4. **承認限制**：Claude 不確定的時候讓它說，這是有價值的
5. **寫測試重現**：能重現 bug 的測試，比猜測好一百倍
